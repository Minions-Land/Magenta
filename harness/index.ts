...
//   harness-component-protocol/contract/  — the three-role contracts (HcpServer, HcpMagnet, ...)
...
export * from "./harness-component-protocol/server/capability-server.ts";
export * from "./harness-component-protocol/server/module-server.ts";
...
export * from "./modules/compaction/HcpServer.ts";
