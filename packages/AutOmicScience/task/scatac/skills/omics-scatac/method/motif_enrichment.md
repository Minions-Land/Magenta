...
**Maturity: REFERENCE** — no runtime subcommand; hand-rolled in `run_python`. Two complementary questions, two tools: per-cell **chromVAR** (default for TF *activity*) and marker-region **enrichment** (which TFs mark a cluster).
