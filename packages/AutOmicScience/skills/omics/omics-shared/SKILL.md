...
|----------|-------|-------------|
| scRNA-seq | `skills/omics/omics-scrna/SKILL.md` | `skills/omics/omics-scrna/method/*.md` |
| Spatial | `skills/omics/omics-spatial/SKILL.md` | `skills/omics/omics-spatial/method/*.md` |
| scATAC-seq | `skills/omics/omics-scatac/SKILL.md` | `skills/omics/omics-scatac/method/*.md` |
| Multiome | `skills/omics/omics-multiome/SKILL.md` | `skills/omics/omics-multiome/method/*.md` |

The shared method docs (`skills/omics/omics-shared/method/*.md`) cover containers, data context, preprocessing, grounding, visualization, figure inspection, and data acquisition — read them on demand.
