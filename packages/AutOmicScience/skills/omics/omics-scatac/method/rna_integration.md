...
- **Method for the shared space** — **scVI/scANVI-style or ingest/kNN label transfer** reusing the **scRNA integration recipe** (`skills/omics/omics-scrna/method/integration.md`). Choose by reference size and batch:
...
The agent **reads `skills/omics/omics-scrna/method/integration.md`** and **`annotation.md`** — they are already written and cover:
