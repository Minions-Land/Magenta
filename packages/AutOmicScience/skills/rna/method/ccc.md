...
**Maturity: REFERENCE** — no compute subcommand; one opinionated recipe below, run in `run_python`; emit a `report` dict and pass it to `evidence_from_kernel_cell` to stay grounded.
