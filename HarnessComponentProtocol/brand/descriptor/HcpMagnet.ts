...
/** Descriptor Source for brand Resources supplied by a host or Package. */
...
function HcpMagnetsettings(settings: unknown): HcpMagnetResourcebuildsettings {
	if (
		...
		throw new Error("brand:descriptor requires Resource settings with content or contentPath");
	}
	return settings;
}
