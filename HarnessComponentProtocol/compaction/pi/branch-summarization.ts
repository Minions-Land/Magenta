...
import type { BranchSummaryResult, Session, SessionTreeEntry } from "../../_magenta/types/types.ts";
import { BranchSummaryError, err, ok, type Result, SessionError } from "../../_magenta/types/types.ts";
...
export type BranchSummaryDetails = {
...
export type CollectEntriesResult = {
...
export type GenerateBranchSummaryOptions = {
