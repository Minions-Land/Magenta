...
import type { EditOperations } from "../../tools/edit/pi/edit.ts";
import type { ReadOperations } from "../../tools/read/pi/read.ts";
import type { WriteOperations } from "../../tools/write/pi/write.ts";
...
export type SshPtyDisposable = {
	dispose(): void;
};

export type SshPtyProcess = {
...
export type SshPtySpawnOptions = {
	name: string;
	cols: number;
	rows: number;
	cwd: string;
...
export type SshToolOperationsOptions = {
	/**
