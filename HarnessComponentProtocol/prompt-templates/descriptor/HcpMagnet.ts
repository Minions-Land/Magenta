...
/** Descriptor Source for prompt-template Resources supplied by a host or Package. */
export class HcpMagnet {
	...
	readonly kind = "resource:prompt-template";
...
function HcpMagnetsettings(settings: unknown): HcpMagnetResourcebuildsettings {
	if (
		...
		throw new Error("prompt-templates:descriptor requires Resource settings with content or contentPath");
	}
	return settings;
}
