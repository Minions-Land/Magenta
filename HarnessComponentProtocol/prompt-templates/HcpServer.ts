import type { ExecutionEnv, PromptTemplate } from "../_magenta/types/types.ts";

export class HcpServer {
	readonly moduleName = "prompt-templates";
	readonly description = "Prompt template discovery and rendering.";
}
...
export type PromptTemplateProvider = {
	load(
		env: ExecutionEnv,
		paths: string | string[],
