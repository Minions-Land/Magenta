...
export type HarnessImplementationDescriptor = {
...
export type HarnessModuleStatus = "ready" | "registered";

export type HarnessModuleDescriptor = {
	id: string;
	kind: string;
	name: string;
	description?: string;
...
export function getHarnessRegistryPath(): string {
	...
	const candidates = [
		...
		resolve(here, "../../../harness.toml"),
		resolve(here, "../../../../harness.toml"),
		resolve(process.cwd(), "HarnessComponentProtocol", "harness.toml"),
...
export function buildHarnessModuleDescriptors(components: ComponentDescriptor[]): HarnessModuleDescriptor[] {
	return components.map((component) => {
		...
		const status: HarnessModuleStatus = implementations.some((implementation) => implementation.status === "ready")
			? "ready"
			: "registered";
		return {
			id,
