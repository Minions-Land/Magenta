...
export type HarnessPackageProfile = {
	name: string;
	description?: string;
	extends: string[];
	harness?: string;
...
export type HarnessPackageManifest = {
...
export type PackageComponentRef = {
	kind: string;
	name: string;
	description?: string;
	path?: string;
...
export type PackageComponentBundle = {
	kind: string;
	name?: string;
	source: string;
	raw: string;
...
export type DiscoverHarnessPackagesResult = {
	repoRoot: string;
	packagesRoot: string;
	packages: HarnessPackage[];
	diagnostics: PackageDiagnostic[];
