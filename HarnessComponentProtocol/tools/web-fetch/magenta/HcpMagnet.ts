...
export class HcpMagnet {
	static readonly module = "tools/web-fetch";
	static readonly kind = "tool";
	static readonly source = "magenta";
	static async build(context: HcpMagnetBuildContext) {
		if (!context.descriptorPath) throw new Error("tools/web-fetch:magenta requires a component descriptor");
		...
		if (!runtime || !sandbox) throw new Error("tools/web-fetch:magenta requires runtime:process and sandbox");
