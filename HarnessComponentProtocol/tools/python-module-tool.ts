...
export type PythonModuleToolSpec<TParameters extends TSchema = TSchema> = Omit<
	ProcessToolSpec<TParameters>,
	"buildInvocation"
> & {
	module: string;
	modulePath?: string;
...
export class PythonModuleTool<TParameters extends TSchema = TSchema> extends ProcessTool<TParameters> {
