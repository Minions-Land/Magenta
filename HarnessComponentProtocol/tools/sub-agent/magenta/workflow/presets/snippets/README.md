...
These snippets assume your workflow follows the plan → implement → observe → reflect → refine loop discipline from the research-orchestration skill. If you're writing a workflow from scratch, read `HarnessComponentProtocol/skills/research-orchestration/pi/SKILL.md` first.
...
See `HarnessComponentProtocol/skills/research-orchestration/pi/assets/references/loop-principles.md` for the theory.
