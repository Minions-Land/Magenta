...
export class HcpMagnet {
	static readonly module = "tools/lsp";
	static readonly kind = "tool";
	static readonly source = "magenta";

	static async build(context: HcpMagnetBuildContext) {
		if (!context.descriptorPath) throw new Error("tools/lsp:magenta requires a component descriptor");
		...
		if (!runtime || !sandbox) throw new Error("tools/lsp:magenta requires runtime:process and sandbox");
