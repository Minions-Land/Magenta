...
export type SessionGroundingMemoryOptions = {
...
export type SessionGroundingReadResult = MemoryReadResult & {
	name: "session-grounding";
	target: "memory://session-grounding";
	entries: SessionGroundingMemoryEntry[];
};

export type SessionGroundingRetainResult = MemoryRetainResult & {
	target: "memory://session-grounding";
	op: "retain";
	scope: string;
	tags: string[];
...
export type SessionGroundingRecallResult = MemoryRecallResult & {
	target: "memory://session-grounding";
	op: "recall";
	matches: Array<SessionGroundingMemoryEntry & { score: number }>;
};

export type SessionGroundingReflectResult = MemoryReflectResult & {
	target: "memory://session-grounding";
	op: "reflect";
	matches: Array<SessionGroundingMemoryEntry & { score: number }>;
};
