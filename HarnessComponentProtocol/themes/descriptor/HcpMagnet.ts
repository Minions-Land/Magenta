...
/** Descriptor Source for theme Resources supplied by a host or Package. */
export class HcpMagnet {
	static readonly module = "themes";
	static readonly kind = "theme";
...
function HcpMagnetsettings(settings: unknown): HcpMagnetResourcebuildsettings {
	if (
		...
		throw new Error("themes:descriptor requires Resource settings with content or contentPath");
	}
	return settings;
}
