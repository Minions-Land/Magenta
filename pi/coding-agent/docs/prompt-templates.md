> Magenta can create prompt templates. Ask it to build one for your workflow.
...
Magenta loads prompt templates from:

- Global: `~/.magenta/agent/prompts/*.md`
- Project: `.magenta/prompts/*.md` (only after the project is trusted)
