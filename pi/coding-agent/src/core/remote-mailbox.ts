...
import { MessageStore, type PeerEndpoint, type SshTarget } from "@magenta/harness";
import { getAgentInvocation } from "../config.ts";
...
export class RemoteMailboxController {
	...
	private readonly resolveInvocation: typeof getAgentInvocation;
	...
	constructor(
		...
		options?: {
			...
			resolveInvocation?: typeof getAgentInvocation;
		...
		this.resolveInvocation = options?.resolveInvocation ?? getAgentInvocation;
