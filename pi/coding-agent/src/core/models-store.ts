/**
 * ModelsStore implementations for coding-agent (CC-052 P2.3, upstream 9993c969).
 *
 * Backs dynamically refreshed provider catalogs. FileModelsStore reuses the
 * AuthStorageBackend file-lock machinery so catalog writes are serialized the
 * same way credential writes are.
 */
