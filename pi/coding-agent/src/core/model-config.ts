/**
 * Model Config - immutable, credential-blind models.json snapshot.
 * 
 * Ported from upstream 9993c969 (CC-048 ModelRuntime gate) with Magenta's
 * W5-aligned cost schema (AI-023/CC-037: {tiers: {default, scale}} not upstream's
 * [{inputTokensAbove}]). Preserves Magenta's sendSessionIdHeader compat shim (CC-042).
 */
...
// ===== SCHEMAS (from current model-registry.ts, W5-aligned) =====
...
// Session affinity format (CC-042/AI-032)
...
const OpenAIResponsesCompatSchema = Type.Object({
	supportsDeveloperRole: Type.Optional(Type.Boolean()),
	/** @deprecated Use sessionAffinityFormat instead. Kept as backward-compat shim (CC-042). */
...
// ModelCost schema: W5-aligned {tiers: {default, scale}} (AI-023/CC-037)
...
/**
 * One immutable load of models.json. Upstream pattern (9993c969) with Magenta
 * schema alignment. Credential-blind: no auth resolution, just structure.
 */
