...
const DEFAULT_SESSIONS_DIR = path.join(homedir(), ".magenta/agent/sessions");
const MODELS_GENERATED_PATH = path.join(process.cwd(), "pi/ai/src/models.generated.ts");
const MODELS_CONFIG_PATH = path.join(homedir(), ".magenta/agent/models.json");
...
Options:
  --sessions-dir <path>  Sessions directory (default: ~/.magenta/agent/sessions)
